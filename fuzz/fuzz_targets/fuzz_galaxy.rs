...
use bevy_force_directed_graph::force_directed_graph::forces::galaxy::apply_galaxy_force;
use bevy_force_directed_graph::force_directed_graph::utils::FiniteOr;
...
fuzz_target!(|data: &[u8]| {
    ...
    app.add_systems(Update, apply_galaxy_force);
